...
- Cash on-ramp (LAUNCHING SOON, not live yet): Loadit has a signed partnership with a licensed national cash network — the shopper will pay cash at a nearby retail counter, the licensed money-transmitter converts it to USDC on Stellar and does the KYC at the counter, then HQ swaps that USDC into whatever asset they chose (BTC, SOL, ETH, …) and delivers it to their own wallet. Non-custodial end to end. It is in final certification; NEVER name the partner and never describe cash-in as available today — say it's launching soon. Card purchases are what work today.
