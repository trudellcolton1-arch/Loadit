...
const SLIDES: ReactNode[] = [
  ...
  <div key="model" className="deck-body">
    ...
    <h2 className="deck-h2">A take rate on every dollar routed.</h2>
    <div className="deck-two">
      <ul className="deck-list">
        <li>
          <b>0.5–1% of GMV</b> — a Loadit spread on the conversion plus rebates shared by
          the on-ramp partners we send volume to.
        </li>
        <li>
          <b>Non-custodial by design</b> — because licensed partners settle the money,
          Loadit avoids money-transmitter licensing: high margin, fast to scale.
        </li>
        <li>
          <b>Repeat behavior</b> — cash-to-crypto users transact small and often, so
          revenue compounds with retention, not just acquisition.
        </li>
      </ul>
      <div className="deck-econ glass">
        ...
        <div className="deck-econ-row"><span>Loadit take (0.75%)</span><b className="text-rail-gradient">$1.13</b></div>
  ...
  <div key="revenue" className="deck-body">
    ...
    <p className="deck-note font-mono">0.75% blended take rate, ~$150–200 avg order. Illustrative, not a forecast.</p>
  </div>,
