...
export const FAQS = [
  {
    q: "What is Loadit?",
    a: "Loadit is an AI-powered financial rail that converts cards and fiat into stablecoins and crypto in seconds. Retail cash-in through a licensed national cash network: cert approved (4/5) — final go-live step pending; cash-in not live yet. Its patent-pending Unified Financial Rail uses its AI, HQ, to route every payment across the cheapest, fastest network available.",
  },
  {
    q: "How will Loadit turn cash into crypto?",
    a: "Card purchases work today through licensed partners. Cash-in — cert approved (4/5), final go-live step pending, not live yet — will let a shopper hand cash to a nearby retail counter; the transaction is identity-verified there and routed by HQ across L1s, L2s, Lightning, or banks, settling on-chain in seconds.",
  },
  {
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "The Loadit app turns cards into Bitcoin, Solana, Ethereum, or USDC in seconds. Retail cash-in: cert approved (4/5) — final go-live step pending; cash-in not live yet. Non-custodial, AI-routed, with HQ (an in-app AI money assistant), Pulse offline Bluetooth payments, send to any @handle or wallet, and a flat 0.75% fee.",
        publisher: { "@id": `${SITE.url}/#organization` },
